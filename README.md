...
Проект открыт для самостоятельного использования и доработки. Если хотите адаптировать его под свои сценарии автоматизации Spotify, удобнее всего начать с `apps/auto-playlists`.
