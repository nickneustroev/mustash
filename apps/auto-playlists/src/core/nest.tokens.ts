...
export const AUTO_PLAYLISTS_FAST_SYNC_SERVICE = Symbol("AUTO_PLAYLISTS_FAST_SYNC_SERVICE");
export const AUTO_PLAYLISTS_FULL_SYNC_SERVICE = Symbol("AUTO_PLAYLISTS_FULL_SYNC_SERVICE");
